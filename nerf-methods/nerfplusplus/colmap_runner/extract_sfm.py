...
if __name__ == '__main__':
    # sparse_dir = '/ssd1/wangchen/data/kitti_depth_proj/sparse/0'
    # out_dir = '/ssd1/wangchen/kitti_nerfplusplus/kitti_depth_proj'
    sparse_dir = '/ssd1/wangchen/data/kittiSeq02_llffdtu_2011_10_03_drive_0034_sync_170scans_densegt/DTU_format/sparse/0'
    out_dir = '/ssd1/wangchen/data/nerfpp_preprocessed/kittiSeq02_llffdtu_2011_10_03_drive_0034_sync_170scans_densegt'
    extract_all_to_dir(sparse_dir, out_dir, ext='.bin')
