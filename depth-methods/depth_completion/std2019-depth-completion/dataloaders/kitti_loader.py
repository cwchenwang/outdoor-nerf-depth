...
def get_paths_and_transform(split, args):
    ...
    if split == "train":
        ...
        if args.val == "full":
            ...
            glob_gt = os.path.join(
                args.data_folder,
                'data_depth_annotated/train/2011_10_03_drive_0027_sync/proj_depth/groundtruth/image_02/*.png'
            )
...
#                 return p.replace("groundtruth_depth","image")
    ...
    if glob_gt is not None:
        ...
        paths_d = paths_d[2695:2996]
        paths_gt = paths_gt[2695:2996]
        paths_rgb = paths_rgb[2695:2996]
#         print(paths_d)
    else:  
