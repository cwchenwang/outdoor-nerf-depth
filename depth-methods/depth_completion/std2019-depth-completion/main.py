...
parser.add_argument('--data-folder',
                    default='/home/ssd2/lina/kitti_data_completion/',
                    type=str,
                    metavar='PATH',
...
parser.add_argument('-e', '--evaluate', default='stage_1.tar', type=str, metavar='PATH')
...
def iterate(mode, args, loader, model, optimizer, logger, epoch):
    ...
    for i, batch_data in enumerate(loader):
        ...
        # save
        output = 'std_result/%010d.png'%(i+2700)
        pred1 = pred.data.cpu().numpy()
        pred1 = np.squeeze(pred1)
#         print(pred1.shape)
        pred1 = np.pad(pred1,((24,0),(12,13)),'constant',constant_values = (0,0))
#         print(pred1.shape)
#         print(sha)
        pred_show =  pred1* 256.0
